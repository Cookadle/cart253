...
## [Lanna Check](https://lannacheck-ops.github.io/cart253/mod-jam/frogfrogfrog/)
...
Also, once the tutorial is over, the instructions loop over and over. I understand the escape button was added for this effect, but I think making the tutorial lead to the game or main screen by itself once it's done explaining would have been a great addition.
...
Really cool art  style, for me what left a deep impression was the art style, not the gameplay. As I know Kerven and his love  for  rage bait,  I  will not comment on the [gameplay](https://github.com/yatsukki/cart253/tree/main/topic/events/flying-frogs) main goal. He implemented the buttons very well, it's cool that they actually push down when you hover over them, beautiful title screen as well, the floating title, the moving clouds, all in all beautiful creative work *chef's kiss*. You can see Kerven skill, as a graphic designer,  truly shine here.

I  won't be tricked to be mad BUT as Kerven tries to [rage bait](https://www.merriam-webster.com/slang/rage-bait) you with his hardcore game mechanic, I have found a way to avoid the flies without having to move much. By staying at the top of the screen and staying in the corner I have managed to stay alive for 42 seconds, which isn't much but not a lot of effort was created to afford this 42 second of survival. I think, working on the fly flying system so that the wave movement  is able to reach the top and bottom of the screen more often or make the fly have different starting point would make it even more challenging.
